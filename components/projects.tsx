...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description: "Web desarrollador para el área de Ambiente de la Municipalidad de Las Flores.",
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <AnimationWrapper key={project.id} animation="slideUp" delay={0.2 * (index + 1)}>
        ...
        <AnimationWrapper animation="fadeIn" delay={0.8} className="text-center mt-12 pb-12">
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              variant="outline"
